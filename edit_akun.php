                                ...
                                <div class="card-body">
                                    <form method="POST" action="#" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value='<?php echo $name; ?>'  name="name" id="name" required="required" placeholder="ketik" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="gender">Email</label>
                                            <input type="email" value='<?php echo $email; ?>' name="email" id="email" required="required" placeholder="ketik" autocomplete="off" class="form-control">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $mysqli->close();
                                    ?>
                                </div><!--End of card body Daftar Akun -->
                            </div><!--End of card shadow Daftar Akun -->
                        </div><!--End of Daftar Akun -->
